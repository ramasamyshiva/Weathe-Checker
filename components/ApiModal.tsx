    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
      <InfoCard className="max-w-2xl w-full flex flex-col" onClick={(e) => e.stopPropagation()}>
        <div className="flex justify-between items-center mb-4 flex-shrink-0">
          <h2 className="text-2xl font-bold text-white">Raw API Response</h2>
          <div className="flex items-center gap-2">
            <button 
              onClick={handleCopy}
              className="px-3 py-1.5 bg-white/10 text-slate-300 rounded-md text-sm hover:bg-white/20 transition-colors flex items-center gap-2"
            >
        ...
        <div className="bg-slate-900/70 rounded-lg p-4 overflow-auto max-h-[70vh]">
